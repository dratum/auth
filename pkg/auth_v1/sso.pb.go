...
const file_sso_proto_rawDesc = "" +
	"\n" +
	"\tsso.proto\x12\x04auth\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa0\x01\n" +
	...
	"\x04Role\x12\b\n" +
	"\x04user\x10\x00\x12\t\n" +
	"\x05admin\x10\x012\xd7\x01\n" +
	"\x06AuthV1\x123\n" +
	"\x06Create\x12\x13.auth.CreateRequest\x1a\x14.auth.CreateResponse\x12*\n" +
	"\x03Get\x12\x10.auth.GetRequest\x1a\x11.auth.GetResponse\x125\n" +
	"\x06Update\x12\x13.auth.UpdateRequest\x1a\x16.google.protobuf.Empty\x125\n" +
	"\x06Delete\x12\x13.auth.DeleteRequest\x1a\x16.google.protobuf.EmptyB,Z*github.com/dratum/auth/pkg/auth_v1;auth_v1b\x06proto3"
...
var file_sso_proto_depIdxs = []int32{
	...
	0,  // 1: auth.GetResponse.role:type_name -> auth.Role
	7,  // 2: auth.GetResponse.created_at:type_name -> google.protobuf.Timestamp
	7,  // 3: auth.GetResponse.updated_at:type_name -> google.protobuf.Timestamp
	8,  // 4: auth.UpdateRequest.name:type_name -> google.protobuf.StringValue
	8,  // 5: auth.UpdateRequest.email:type_name -> google.protobuf.StringValue
	1,  // 6: auth.AuthV1.Create:input_type -> auth.CreateRequest
	3,  // 7: auth.AuthV1.Get:input_type -> auth.GetRequest
	5,  // 8: auth.AuthV1.Update:input_type -> auth.UpdateRequest
	6,  // 9: auth.AuthV1.Delete:input_type -> auth.DeleteRequest
	2,  // 10: auth.AuthV1.Create:output_type -> auth.CreateResponse
	4,  // 11: auth.AuthV1.Get:output_type -> auth.GetResponse
	9,  // 12: auth.AuthV1.Update:output_type -> google.protobuf.Empty
	9,  // 13: auth.AuthV1.Delete:output_type -> google.protobuf.Empty
